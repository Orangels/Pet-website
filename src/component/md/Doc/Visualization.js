...
import { visualization_data, visualization_data_CN} from '../../../common/data/component_data'
import '../style/visualization.less'
...
class Visualization extends Component {
    ...
    render() {
        ...
        let en = props.en
        let data_arr = [visualization_data, visualization_data_CN]
        return (
            en === 0 ? (
