...
import {
    model_construction_data,
    model_construction_data_CN
} from '../../../common/data/component_data'
import '../style/model_construction.less'
import Md_content_component_EN from "../common/Md_content_component_EN";

class Model_construction extends Component {
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
    ...
    render() {
        ...
        let en = props.en
        let data_arr = [model_construction_data, model_construction_data_CN]
        return (
            en === 0 ? (
...
export default Model_construction