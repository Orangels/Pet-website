...
import {load_model_data, load_model_data_CN} from '../../../common/data/component_data'
import '../style/load_model.less'
import Md_content_component_EN from "../common/Md_content_component_EN";

class Load_model extends Component {
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
    ...
    render() {
        ...
        let en = props.en || 0
        let data_arr = [load_model_data, load_model_data_CN]
