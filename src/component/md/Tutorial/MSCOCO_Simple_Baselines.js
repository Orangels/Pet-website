...
import {
    MSCOCO_Simple_Baselines_EN,
    MSCOCO_Simple_Baselines_CN,
...
class MSCOCO_Simple_Baselines extends Component {
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
    ...
    render() {
        ...
        let en = props.en
        let data_arr = [MSCOCO_Simple_Baselines_EN, MSCOCO_Simple_Baselines_CN]
...
export default MSCOCO_Simple_Baselines