...
import {
    CIHP_Parsing_R_CNN_EN,
    CIHP_Parsing_R_CNN_CN,
...
class CIHP_Parsing_R_CNN extends Component {
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
    ...
    render() {
        ...
        let en = props.en
        let data_arr = [CIHP_Parsing_R_CNN_EN, CIHP_Parsing_R_CNN_CN]
...
export default CIHP_Parsing_R_CNN