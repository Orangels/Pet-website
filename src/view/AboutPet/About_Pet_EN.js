...
import About_Pet_table_component from './About_Pet_table_component'
import About_Pet_Roulette from './About_Pet_Roulette'


import './About_Pet.less'

import {About_Pet_data} from './About_Pet_data'
...
import Header_banner from "../../asset/HOME_icon/banner/about-pet.jpg";
import roulette_banner from "../../asset/HOME_icon/about_Pet/roulette_banner.jpg";
...
export default class AboutPet_EN extends React.Component{
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <Layout style={style.wrap} className={'About_Pet'}>
                        ...
                        <BannerAnim prefixCls="header" autoPlay>
                            ...
                            >
                                ...
                                <TweenOne className="banner-user-text"
                                          ...
                                          component='span'
                                          style={{fontSize:30*screen_scale_width,color:"#484B4D",letterSpacing:1}}
                                >
                                    {/*{'Pet &nbsp;is&nbsp; short&nbsp; for&nbsp; Pytorch&nbsp; efficient&nbsp; toolbox&nbsp; for&nbsp; Computer &nbsp;Vision.'}*/}
                                    Pet is short for Pytorch efficient toolbox for Computer Vision.
                                </TweenOne>
                                <TweenOne className="banner-user-text"
                                          animation={{ y: 30, opacity: 0, type: 'from', delay: 100 }}
                                          ...
                                          style={{fontSize:30*screen_scale_width,color:"#484B4D",letterSpacing:1}}
                                >
                                    {/*{'Get &nbsp;start&nbsp; your&nbsp; research&nbsp; quickly, &nbsp;flexibly&nbsp; and&nbsp; efficiently&nbsp; by&nbsp; using &nbsp;Pet.'}*/}
                                    Get start your research quickly, flexibly and efficiently with Pet.
                                </TweenOne>
                            </Element>
                        </BannerAnim>
                ...
                <div style={style.part_wrap}>
                    <div style={style.content}>
                        <div style={{display:"flex", flexDirection:"column", height:'auto', width:model_width, backgroundColor:'#FFFFFF'}}>
                            <div style={{display:'flex', justifyContent:'center',
                                position:"relative",
                                marginBottom:20*screen_scale_width
                            }}
                            className={'About_Pet_Roulette_wrap'}>
                                <div style={{
                                    background:`url(${roulette_banner}) no-repeat `,
                                    width: '100%',
                                    height:'100%',
                                    backgroundSize: '100% 100%',
                                    position:"absolute",
                                ...
                                <About_Pet_Roulette en={0} />
                            </div>
                            <About_Pet_table_component en={0} top={100*screen_scale_width}/>
                        </div>
                    </div>
                </div>
