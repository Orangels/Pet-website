                        ...
                        <BannerAnim prefixCls="header" autoPlay>
                            ...
                            >
                                ...
                                <TweenOne className="banner-user-text"
                                          ...
                                          component='span'
                                          style={{fontSize:28*screen_scale_width,color:"#484B4D"}}
                                >
                                    Pet是一个基于Pytorch实现的高效计算机视觉工具
                                </TweenOne>
                                <TweenOne className="banner-user-text"
                                          animation={{ y: 30, opacity: 0, type: 'from', delay: 100 }}
                                          component='span'
                    ...
                    <div style={style.content}>
                        <div style={{display:"flex", flexDirection:"column", height:'auto', width:model_width, backgroundColor:'#FFFFFF'}}>
                            <div style={{display:'flex', justifyContent:'center',
                                ...
                                <About_Pet_Roulette en={1} />
                            </div>
                            <About_Pet_table_component en={1} top={100*screen_scale_width}/>
                        </div>
                    </div>
                </div>
