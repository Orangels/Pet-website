export let test_MD_data = {
    key: 'pet.{task}.ops接口',
    dataSource: [
        {title:'pet.{task}.ops接口'},
        {text:'通过pet.{task}.ops接口可以实例化一些不同视觉任务中所使用的特殊操作符，可以通过Python的import功能直接引入。\n'},
        {part_title:'pet.rcnn.ops接口'},
        {text:  '> class pet.rcnn.ops.DeformRoIPooling()\n' +
                '\n' +
