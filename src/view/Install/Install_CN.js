...
import {Layout, Menu, Icon, Button, Table, Dropdown, Anchor} from 'antd/lib/index';
                ...
                <div style={{display:'flex',
                    ...
                    <div style={{display:'flex',
                        ...
                        >
                            ...
                            <Menu.Item key="3" style={{fontSize:24*screen_scale_width,fontWeight:1000,}}>安装</Menu.Item>
                        ...
                        <BannerAnim prefixCls="header" autoPlay>
                            ...
                            >
                                ...
                                <TweenOne className="banner-user-title" animation={{ y: 30, opacity: 0, type: 'from' }}
                                          component='span'
                                          style={{fontSize:62*screen_scale_width,color:"#FFFFFF",}}
                                >
                                    快速安装并使用 Pet
                                </TweenOne>
                                <TweenOne className="banner-user-text"
                                          ...
                                          component='span'
                                          style={{fontSize:28*screen_scale_width,color:"#FFFFFF"}}
                                >
                                    开启您的深度学习之旅, 让您想法变为可能!
                                </TweenOne>
                            </Element>
                ...
                <div style={style.part_wrap}>
                    <div className={'install_contact_dic'} style={{display:"flex", flexDirection:"row", height:'auto', width:model_width,}}>
                        <div  style={{display:"flex", flexDirection:"column", height:'auto',width:1220*screen_scale_width,marginLeft:100*screen_scale_width,
                            ...
                            <p style={{fontSize:44*screen_scale_width,color: "#2B2D2E",letterSpacing:1.32*screen_scale_width,}}>
                                Pet 部署
                            </p>
                            <span style={{fontSize:20*screen_scale_width, color: "#484B4D",marginTop:30*screen_scale_width}}>
                                在安装下载配置Pet之前，需保证Pet所需的系统环境已经安装完成。pet的环境要求如下
                            </span>
                            <span id={'environment'} style={{fontSize:26*screen_scale_width,color:'#A04E37',letterSpacing:0.15*screen_scale_width,
                            ...
                            <span id={'environment'} style={{fontSize:20*screen_scale_width,letterSpacing:0.15*screen_scale_width,
                                marginTop:30*screen_scale_width}}>
                                自行完成所需环境部署后可以按照下述步骤逐步的完成Pet的部署。
                            </span>
                            {/*<Template_li>*/}
                            {/*    <span id={'dependencies'} style={{fontSize:23*screen_scale_width,color: "#2B2D2E",letterSpacing:0.15}}>*/}
                            {/*    安装基础包*/}
                            {/*    </span>*/}
                            {/*</Template_li>*/}
                            {/*<Install_codePart_component en={1} data={Install_codePart_data_EN['Install basic dependencies']}*/}
                            {/*                            style={{marginTop:30*screen_scale_width}}/>*/}
                            <Template_li>
                                <p id={'pytorch'} style={{color: "#484B4D",fontSize:23*screen_scale_width,letterSpacing:0.15*screen_scale_width}}>
                                    安装Pytorch-1.1.0:
                                </p>
                            </Template_li>
                            <Install_codePart_component en={1} data={Install_codePart_data_EN['Install Pytorch']}
                                                        style={{marginTop:20*screen_scale_width}}/>
                            <Template_li>
                                <p id={'torchvision'} style={{color: "#484B4D",fontSize:23*screen_scale_width,letterSpacing:0.15*screen_scale_width,marginTop:20*screen_scale_width}}>
                                    安装torchvision-0.3.0
                                </p>
                            </Template_li>
                            <Install_codePart_component en={1} data={Install_codePart_data_EN['Install torchvision']}
                                                        style={{marginTop:20*screen_scale_width}}/>
                            <Template_li>
                                <p id={'apex'} style={{color: "#484B4D",fontSize:23*screen_scale_width,letterSpacing:0.15*screen_scale_width,}}>
                                    安装NVIDIA apex:
                                </p>
                            </Template_li>
                            <Install_codePart_component en={1} data={Install_codePart_data_EN['apex']}
                                                        style={{marginTop:20*screen_scale_width}}/>
                            <Template_li>
                                <p id={'pycocotools'} style={{color: "#484B4D",fontSize:23*screen_scale_width,letterSpacing:0.15*screen_scale_width,}}>
                                    安装pycocotools
                                </p>
                            </Template_li>
                            <Install_codePart_component en={1} data={Install_codePart_data_EN['pycocotools']}
                                                        style={{marginTop:20*screen_scale_width}}/>
                            <Template_li>
                                <p id={'install_Pet'} style={{marginTop:50*screen_scale_width,fontSize:23*screen_scale_width,color: "#2B2D2E",letterSpacing:0.15}}>
                                    下载并安装Pet：
                                </p>
                            </Template_li>
                            <Install_codePart_component en={1} data={Install_codePart_data_EN['Clone Pet']}
                                                        style={{marginTop:20*screen_scale_width}}/>
                            <p style={{color: "#A05937",fontSize:20*screen_scale_width,letterSpacing:0.2*screen_scale_width,marginTop:50*screen_scale_width}}>
                                注：此处如显示"x86_64-linux-gpu-gcc"等报错信息，请输入如下命令解决：
                            </p>
                            <Install_codePart_component en={1} data={Install_codePart_data_EN['ps']}
                                                        style={{marginTop:20*screen_scale_width}}/>
                            <p style={{color: "#A05937",fontSize:20*screen_scale_width,letterSpacing:0.2*screen_scale_width,marginTop:50*screen_scale_width}}>
                                至此，就完成了Pet的全部安装过程。
                            </p>
                        ...
                        <Anchor className={'dataNav'}
                            ...
                            <span style={{fontSize:26*screen_scale_width,color:'#3765A0',letterSpacing:0.15*screen_scale_width,marginTop:20*screen_scale_width, marginLeft:20*screen_scale_width}}>
                                Pet 安装步骤
                            </span>
                            <Link href={'#environment'} title={'Pet 环境'}/>
                            {/*<Link href={'#dependencies'} title={'Pet 依赖'} />*/}
                            ...
                            <Link href={'#install_Pet'} title={'安装 Pet'} />
                            <div style={{width:440*screen_scale_width,height:'auto',border:'1px solid #FF8722',marginTop:20*screen_scale_width,
                                marginLeft:20*screen_scale_width,display:'flex',flexDirection:"column",}}>
                                {/*// part1*/}
