...
import { model_content_data } from './model_content_data'
...
class Model_Zoo_EN extends Component{
    ...
    render() {
        ...
        console.log(`Render ${this.props.selectKey}`)
        ...
        return (
            <Layout style={{...style.wrap, }} className={'Model_Zoo Model_Zoo_EN'}>
                <div style={{display:'flex',
                    ...
                    <div style={{display:'flex',
                        ...
                        >
                            ...
                            <Menu.Item key="6" style={{fontSize:24*screen_scale_width,fontWeight:1000,}}>Model Zoo</Menu.Item>
                ...
                <Layout style={{...style.part_wrap,backgroundColor:'#F7F7F7'}}>
                    <div style={{display:"flex", flexDirection:"row", height:'auto', width:model_width,}}>
                        <div style={{
                            overflow: 'auto', height: model_height,position: 'sticky', left: 0, top:heart_height,
                            // width:1000*screen_scale_width,
                        ...
                        >
                            <Menu theme="light" mode="inline"  defaultOpenKeys={[open_key]} defaultSelectedKeys={[select_key]} onClick={this._click_nav}
                                ...
                                <SubMenu key={'0'}  title={<span style={style.subMenu_item}> Classification</span>}>
                                ...
                                <SubMenu key={'10'} title={<span style={style.subMenu_item}> Detection</span>}>
                                ...
                                <SubMenu key={'20'} title={<span style={style.subMenu_item}>Segmentation</span>}>
                                ...
                                <SubMenu key={'30'} title={<span style={style.subMenu_item}>Keypoints</span>}>
                                ...
                                <SubMenu key={'40'} title={<span style={style.subMenu_item}>Face</span>}>
                                    {DSN_Arr_Pose.map((item,i)=>{
                                        return (
                                ...
                                <SubMenu key={'50'} title={<span style={style.subMenu_item}>Parsing</span>}>
                                    {DSN_Arr_Pose.map((item,i)=>{
                                        return (
                                ...
                                <SubMenu key={'60'} title={<span style={style.subMenu_item}>Dense Pose</span>}>
                                    {DSN_Arr_Pose.map((item,i)=>{
                                        return (
                        ...
                        }}>
                            {
                                this.state.current_content < 20 ? (
                                    <Content className="Content_layout_Content" style={{display:'flex', flexDirection:'column', height:'auto',
                                        marginBottom:20}}>
                                        <ModeL_title en={0} data={model_content_data_current} />
                                        ...
                                        <TableTest style={{ width: 'auto', height: 'auto', marginTop:51*screen_scale_width}}
                                                   data_3rd={Classification_Image_3rd_table_data} table_data={ table_data } detail_table_data={detail_table_data} type={Math.floor(this.state.current_content/10)} en={0}/>
