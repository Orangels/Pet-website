...
import {Contact_us_data_EN as Contact_us_data} from './Contact_us_data'
...
export default class Contact_us_EN extends React.Component{
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <Layout style={style.wrap} className={'Contact_us Contact_us_EN'}>
                ...
                <div style={{...style.part_wrap,...style.header_banner,marginTop:heart_height}}>
                    <div style={style.header} className={'contact_us_header'}>
                        ...
                        >
                            ...
                            <Contact_us_logo_component en={0} data={Contact_us_data['lab']} style={{marginTop:50*screen_scale_width}}/>
                        </div>
                ...
                <div style={style.content}>
                    <div style={{display:"flex", flexDirection:"column", height:'auto', width:model_width, flexWrap:'wrap',backgroundColor:'#FFFFFF', marginTop:59*screen_scale_width}}>
                        {/*<Contact_us_content data={Contact_us_data.ORGANIZER} />*/}
