...
import { tutorials_sider_data_EN as tutorials_sider_data } from './tutorials_sider_data'
...
class Tutorials_EN extends Component {
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
    ...
    componentDidMount(){
        ...
        // switch (this.props.history.location.state.some.selectedKeys) {
    ...
    render() {
        ...
        return (
            <Layout style={{...style.wrap, backgroundColor:'#F7F7F7'}} className='Tutorials Tutorials_EN'>
                ...
                <Layout className="Content_layout" style={{ backgroundColor:'#F7F7F7'}}>
                    ...
                    <Layout style={{backgroundColor:'#FFFFFF', marginLeft:5*screen_scale_width, paddingTop:40*screen_scale_width}}>
                        <Content className="Content_layout_Content"
                            ...
                            <Content_component style={{height: 'auto',backgroundColor:'#F8F8F8'}} en={0} type={1}/>
