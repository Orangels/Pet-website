export let Quick_start = {
    key: 'Quick_start',
    dataSource: [
        {title:'Quick start: Train a classification model on CIFAR10 dataset\n', className:'title_1'},
        {text:'According to quick start, you can learn the brief steps of using Pet to train and test a classifier on the CIFAR10 data set. For more information, click the following links:\n'},
        {
            ul:[
                ...
                'Introduction of system components of Pet in [system components](https://github.com/BUPT-PRIV/Pet-DOC/tree/master/%E6%9E%B6%E6%9E%84/component-collects).',
                'See the detailed training and testing code in [$Pet/tools/cls/train_net.py]() and [$Pet/tools/cls/test_net.py]().',
            ]
        },
        ...
        {shell:'```\n' +
                '    ln -s $CIFAR $Pet/data\n' +
                '```\n'},
        {ul:'Register dataset：Pet has already difined the root path of CIFAR10 dataset in [Pet/utils/data/dataset/catalog.py]()义，please turn to [Data Preparation](https://github.com/BUPT-PRIV/Pet-DOC/blob/master/%E6%9E%B6%E6%9E%84/component-collects/%E6%95%B0%E6%8D%AE%E5%88%B6%E5%A4%87.md) for more information of dataset registration。'},
        ...
        {text:'When using Pet to train and test a classifier on CIFAR10, it is necessary to specify a `yaml` file, which contains all the hyper parameters used in training and testing. Here we take [Pet/cfgs/cls/cifar/resnext29-8x64d_cifar10.yaml]() as an example.\n'},
